                    ...
                    <form className="space-y-6">
                        <div>
                            ...
                            <div className="relative mt-1">
                                <input className="flex-1 px-3 py-2 rounded-md bg-gray-800 border-gray-700 text-white placeholder:gray-500" type="text" id="webpage" placeholder="https://facebook.com"  />
                            </div>
                        </div>
                        <div>
                            <label htmlFor="password" className="block text-sm font-medium text-gray-500">Password</label>
                            <div className="relative mt-1">
                                <input className="flex-1 px-3 py-2 rounded-md bg-gray-800 border-gray-700 text-white placeholder:gray-500" type={visiblePassword ? "text" : "password"} id="password" placeholder="Password"   />
                        ...
                        <div className="mt-8 flex flex-row-reverse items-center justify-start gap-3">
                            ...
                            <button type="button" className="py-2 px-3 inline-flex items-center gap-x-2 font-medium rounded-lg border border-white/2 bg-gray-800 text-white hover:cursor-default hover:bg-gray-700">
                                Save changes
                            </button>
                        </div>
                    </form>
